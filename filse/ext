...
#=======================================#
 ...
 su -lp 2000 -c "cmd notification post -S bigtext -t 'OxyPlus Descrete' 'Tag' 'Extreme Profile started applying
 At $(date)'"
...
$BB wget https://raw.githubusercontent.com/DevMohitash/opd11/main/filse/ext -O /data/media/0/zzext
$BB cp -rf /data/media/0/zzext $FILEZERO
$BB rm -rf /data/media/0/zzext
...
kmsg2 $(date)
kmsg2 "Enabling stuffs that are"
...
ctl /sys/kernel/gpu/gpu_governor userspace
...
if [[ "$DEVICE" == guacamole ]]; then
	...
	ctl /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq 1050000
	ctl /sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpu1/cpufreq/scaling_min_freq 1050000
	ctl /sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpu2/cpufreq/scaling_min_freq 1050000
	ctl /sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpu3/cpufreq/scaling_min_freq 1050000
	ctl /sys/devices/system/cpu/cpufreq/policy0/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpufreq/policy0/scaling_min_freq 1050000
	ctl /sys/devices/system/cpu/cpu4/cpufreq/scaling_max_freq 2420000
	ctl /sys/devices/system/cpu/cpu4/cpufreq/scaling_min_freq 1420000
	ctl /sys/devices/system/cpu/cpu5/cpufreq/scaling_max_freq 2420000
	ctl /sys/devices/system/cpu/cpu5/cpufreq/scaling_min_freq 1420000
	ctl /sys/devices/system/cpu/cpu6/cpufreq/scaling_max_freq 2420000
	ctl /sys/devices/system/cpu/cpu6/cpufreq/scaling_min_freq 1420000
	ctl /sys/devices/system/cpu/cpufreq/policy4/scaling_max_freq 2420000
	ctl /sys/devices/system/cpu/cpufreq/policy4/scaling_min_freq 1420000
	ctl /sys/devices/system/cpu/cpu7/cpufreq/scaling_max_freq 2740000
	ctl /sys/devices/system/cpu/cpu7/cpufreq/scaling_min_freq 1990000
	ctl /sys/devices/system/cpu/cpufreq/policy7/scaling_max_freq 2740000
	ctl /sys/devices/system/cpu/cpufreq/policy7/scaling_min_freq 1990000
fi
...
# Fequency tweaks to all CPUs
ctl /sys/devices/system/cpu/cpu0/cpufreq/schedutil/down_rate_limit_us 85000
ctl /sys/devices/system/cpu/cpu0/cpufreq/schedutil/up_rate_limit_us 0
ctl /sys/devices/system/cpu/cpu0/cpufreq/schedutil/pl 0

ctl /sys/devices/system/cpu/cpu4/cpufreq/schedutil/down_rate_limit_us 85000
ctl /sys/devices/system/cpu/cpu4/cpufreq/schedutil/up_rate_limit_us 0
ctl /sys/devices/system/cpu/cpu4/cpufreq/schedutil/pl 0

ctl /sys/devices/system/cpu/cpu7/cpufreq/schedutil/down_rate_limit_us 85000
ctl /sys/devices/system/cpu/cpu7/cpufreq/schedutil/up_rate_limit_us 0
ctl /sys/devices/system/cpu/cpu7/cpufreq/schedutil/pl 0
...
am start -a android.intent.action.MAIN -e toasttext "All Done. Thankyou for your patience" -n mkadp.toast/.MainActivity
 ...
 su -lp 2000 -c "cmd notification post -S bigtext -t 'OxyPlus Descrete' 'Tag' 'Extreme Profile applied without any error
 At $(date)'"
