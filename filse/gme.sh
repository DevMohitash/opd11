...
BRANCH="Gaming Profile"
#=======================================#
#=======================================#

 su -lp 2000 -c "cmd notification post -S bigtext -t 'OxyPlus Descrete' 'Tag' 'Gaming Profile started applying
 At $(date)'"
...
$BB wget https://raw.githubusercontent.com/DevMohitash/opd11/main/filse/gme -O /data/media/0/zzgme
$BB cp -rf /data/media/0/zzgme $FILEZERO
$BB rm -rf /data/media/0/zzgme
...
kmsg2 $(date)
kmsg2 "Enables stuffs that are disabled by other mods if any..."
kmsg2 "----"
...
am start -a android.intent.action.MAIN -e toasttext "Applying of Kernel/CPU/GPU Level Tweaks" -n mkadp.toast/.MainActivity
...
ctl /proc/sys/vm/drop_caches 3
ctl /proc/sys/vm/dirty_background_ratio 22
ctl /proc/sys/vm/dirty_expire_centisecs 200
...
ctl /proc/sys/vm/dirty_writeback_centisecs 1500
...
ctl /proc/sys/vm/extra_free_kbytes 12200
ctl /proc/sys/kernel/random/read_wakeup_threshold 248
ctl /proc/sys/kernel/random/write_wakeup_threshold 2500
ctl /sys/module/lowmemorykiller/parameters/minfree "2560,5120,11520,25600,35840,38400"
...
ctl /dev/stune/background/schedtune.boost 100
ctl /dev/stune/foreground/schedtune.boost 100
ctl /dev/stune/rt/schedtune.boost 1
ctl /dev/stune/top-app/schedtune.boost 100
...
ctl /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor performance
ctl /sys/devices/system/cpu/cpu1/cpufreq/scaling_governor performance
ctl /sys/devices/system/cpu/cpu2/cpufreq/scaling_governor performance
ctl /sys/devices/system/cpu/cpu3/cpufreq/scaling_governor performance
ctl /sys/devices/system/cpu/cpu4/cpufreq/scaling_governor performance
ctl /sys/devices/system/cpu/cpu5/cpufreq/scaling_governor performance
ctl /sys/devices/system/cpu/cpu6/cpufreq/scaling_governor performance
ctl /sys/devices/system/cpu/cpu7/cpufreq/scaling_governor performance
ctl /sys/devices/system/cpu/cpufreq/policy0/scaling_governor performance
ctl /sys/devices/system/cpu/cpufreq/policy4/scaling_governor performance
ctl /sys/devices/system/cpu/cpufreq/policy7/scaling_governor performance
ctl /sys/devices/system/cpu/cpufreq/performance/above_hispeed_delay 0
ctl /sys/devices/system/cpu/cpufreq/performance/boost 1
ctl /sys/devices/system/cpu/cpufreq/performance/go_hispeed_load 75
ctl /sys/devices/system/cpu/cpufreq/performance/max_freq_hysteresis 1
ctl /sys/devices/system/cpu/cpufreq/performance/align_windows 1
ctl /sys/kernel/gpu/gpu_governor performance
ctl /sys/module/adreno_idler/parameters/adreno_idler_active 0
ctl /sys/module/lazyplug/parameters/nr_possible_cores 8
ctl /sys/module/msm_performance/parameters/touchboost 1
ctl /dev/cpuset/foreground/boost/cpus 4-7
ctl /dev/cpuset/foreground/cpus 0-7
ctl /dev/cpuset/top-app/cpus 0-7
...
if [[ "$DEVICE" == guacamole ]]; then
	...
	ctl /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq 1550000
	ctl /sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpu1/cpufreq/scaling_min_freq 1550000
	ctl /sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpu2/cpufreq/scaling_min_freq 1550000
	ctl /sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpu3/cpufreq/scaling_min_freq 1550000
	ctl /sys/devices/system/cpu/cpufreq/policy0/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpufreq/policy0/scaling_min_freq 1550000
	ctl /sys/devices/system/cpu/cpu4/cpufreq/scaling_max_freq 2420000
	ctl /sys/devices/system/cpu/cpu4/cpufreq/scaling_min_freq 2220000
	ctl /sys/devices/system/cpu/cpu5/cpufreq/scaling_max_freq 2420000
	ctl /sys/devices/system/cpu/cpu5/cpufreq/scaling_min_freq 2220000
	ctl /sys/devices/system/cpu/cpu6/cpufreq/scaling_max_freq 2420000
	ctl /sys/devices/system/cpu/cpu6/cpufreq/scaling_min_freq 2220000
	ctl /sys/devices/system/cpu/cpufreq/policy4/scaling_max_freq 2420000
	ctl /sys/devices/system/cpu/cpufreq/policy4/scaling_min_freq 2220000
	ctl /sys/devices/system/cpu/cpu7/cpufreq/scaling_max_freq 2840000
	ctl /sys/devices/system/cpu/cpu7/cpufreq/scaling_min_freq 2640000
	ctl /sys/devices/system/cpu/cpufreq/policy7/scaling_max_freq 2840000
	ctl /sys/devices/system/cpu/cpufreq/policy7/scaling_min_freq 2640000
fi
...
if [[ "$DEVICE" == hotdog ]]; then
	...
	ctl /sys/devices/system/cpu/cpufreq/policy7/scaling_min_freq 2660000
fi

if [[ "$DEVICE" == hotdogg ]]; then
	am start -a android.intent.action.MAIN -e toasttext "Device detected OP7TProMcl" -n mkadp.toast/.MainActivity
	ctl /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq 1550000
	ctl /sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq 1780000
	ctl /sys/devices/system/cpu/cpu1/cpufreq/scaling_min_freq 1550000
...
ctl /sys/devices/system/cpu/cpu4/core_ctl/busy_down_thres 0
...
ctl /sys/devices/system/cpu/cpu0/core_ctl/min_cpus 4
ctl /sys/devices/system/cpu/cpu4/core_ctl/max_cpus 3
ctl /sys/devices/system/cpu/cpu4/core_ctl/min_cpus 3
ctl /sys/devices/system/cpu/cpu7/core_ctl/max_cpus 1
ctl /sys/devices/system/cpu/cpu7/core_ctl/min_cpus 1

kmsg2 $(date) 
kmsg2 "Applied Kernel CPU/GPU Level tweaks..."
kmsg2 "----"

am start -a android.intent.action.MAIN -e toasttext "Kernel/CPU/GPU Tweaks Applied" -n mkadp.toast/.MainActivity
...
#
ctl /proc/sys/vm/page-cluster 0
ctl /sys/block/zram0/max_comp_streams 4
#
kmsg $(date) 
kmsg "ZRAM Tweaked"
kmsg "----"
...
kmsg2 $(date) 
kmsg2 "Display Refresh rate Forced to Highest"
kmsg2 "----"
kmsg2 $(date) 
kmsg2 "All Done."
kmsg2 "Enjoy Gaming Mode"
kmsg2 "----"
...
kmsg3 $(date) 
kmsg3 "Gaming Mode Enabled Manually"
kmsg3 "----"
...
$BB rm -rf /cache/*	
 ...
 su -lp 2000 -c "cmd notification post -S bigtext -t 'OxyPlus Descrete' 'Tag' 'Gaming Profile activated
 At $(date)'"
